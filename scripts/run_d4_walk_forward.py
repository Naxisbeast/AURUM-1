"""D4-specific walk-forward: pure Donchian 20 + BUY+SELL + 2R exit, no state machine."""
...
print(f'\n=== D4 DONCHIAN WALK-FORWARD ({len(windows)} windows) ===')
...
out = ROOT / 'reports' / 'forward_shadow' / 'd4_walk_forward_results.json'
