"""Run the D4 walk-forward with LOOKBACK=20, using local data paths for fair comparison."""
...
out = LOCAL / 'reports' / 'forward_shadow' / f'd4_walk_forward_L{LOOKBACK}_local_results.json'
